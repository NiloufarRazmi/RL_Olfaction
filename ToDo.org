...
*** TODO Silence Cartesian/polar part of the input on both taks + look at the behavior of the agent (x4 experiments)
...
** DONE Plot gradients
** TODO Check why agent coordinates are not on the grid
* Improvements
** DONE Batches
