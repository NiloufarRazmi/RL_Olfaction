...
class Environment:
    ...
    def __init__(self, seed=None, triangle_state=None):
        if seed:
        ...
        if triangle_state:
            self.reset(triangle_state=triangle_state)
        else:
            self.reset(triangle_state=TriangleState.lower)

    def reset(self, triangle_state):
        """Reset the environment."""
        self.TriangleState = triangle_state
        start_state = {
...
class WrappedEnvironment(Environment):
    ...
    def __init__(self, seed=None, one_hot_state=False, triangle_state=None):
    ...
    def reset(self, triangle_state):
        """Wrapper around the base method."""
        state = super().reset(triangle_state=triangle_state)
