...
\label{sec:orgd384b0b}
\begin{frame}[label={sec:org33e5e1f}]{Composite state space}
\small
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org27d9eac}]{Flattened state space -- allocentric setting}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga28100b}]{Flattened state space -- egocentric setting}
\begin{center}
\includegraphics[height=0.9\textheight]{img/state_space_ego.png}
\end{center}
\end{frame}
\begin{frame}[<+->][label={sec:orgc2d6072},fragile]{States \& actions translation}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0becf66}]{Algorithm troubleshooting}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org57a3acf}]{Q-learning with function approximation -- allocentric setting -- without joint representation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5cc320a}]{Q-learning with function approximation -- allocentric setting -- without joint representation}
\begin{center}
\includegraphics[height=0.8\textheight]{img/func_approx_allo_best_actions_maps_nojointrep.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1ecabd8}]{Q-learning with function approximation -- allocentric setting -- with joint representation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgeb0beff}]{Q-learning with function approximation -- allocentric setting -- with joint representation}
\begin{center}
\includegraphics[height=0.8\textheight]{img/func_approx_allo_best_actions_maps_jointrep.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7d847a9}]{Standard Q-learning -- egocentric setting}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4c280a2}]{Standard Q-learning -- egocentric setting}
\begin{center}
\includegraphics[height=0.9\textheight]{img/q-learning_ego_best_actions_maps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org444e4e6}]{Q-learning with function approximation -- egocentric setting}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1079ff3}]{Q-learning with function approximation -- egocentric setting}
\begin{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgcb4af0b}]{Main differences with Niloufar's model}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[<+->][label={sec:org446187e}]{Next steps}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4e46e27},standout]{~}
Questions ?
\end{frame}
\end{document}
