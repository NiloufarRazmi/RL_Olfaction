...
#+BEAMER_HEADER: \institute{Fleischmann Lab}
# #+BEAMER_HEADER: \author{\texorpdfstring{Andrea Pierré\newline\scriptsize\url{andrea_pierre@brown.edu}}{Andrea Pierré}}
#+BEAMER_HEADER:\titlegraphic{\hfill\includegraphics[height=1.5cm]{img/Brown Logo_2016_2 Color Process ST_1300.png}\vspace{8em}\flushright\includegraphics[height=1.5cm]{img/qr-code.png}}
...
#+LaTeX_HEADER: \setlength{\TPHorizModule}{\textwidth}
#+LaTeX_HEADER: \setlength{\TPVertModule}{\textwidth}
...
# #+LaTeX_HEADER: \usepackage{firamath-otf}
