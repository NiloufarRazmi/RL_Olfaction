...
\label{sec:orgdfc5cbe}
\begin{frame}[label={sec:org44eea50},plain]{Collaborators}
%\addtocounter{framenumber}{-1}
...
\begin{frame}[label={sec:orgf8ffd0d}]{Diamond arena experimental setup}
...
\begin{frame}[<+->][label={sec:orgd0219be}]{What is Reinforcement Learning and why use it ?}
\begin{columns}
\begin{column}{0.55\columnwidth}
% \usepackage{fontawesome5}
...
\begin{frame}[label={sec:org5b35b3f}]{RL maps states to actions}
\center
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=\textheight]{img/RL_mapping-1.drawio.png}};
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgbabf785}]{RL maps states to actions}
\center
\addtocounter{framenumber}{-1}
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=\textheight]{img/RL_mapping-1.drawio.png}};
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgcc34aeb}]{RL maps states to actions}
\addtocounter{framenumber}{-1}
\center
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=\textheight]{img/RL_mapping-1.drawio.png}};
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgb95a5fc}]{RL maps states to actions}
\addtocounter{framenumber}{-1}
\center
\begin{tikzpicture}
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org8768797}]{RL maps states to actions}
\addtocounter{framenumber}{-1}
\center
\begin{tikzpicture}
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgdda15ae},standout]{~}
\raggedright
Which representations are needed by the brain to learn a place-odor association task ?
\end{frame}
\begin{frame}[label={sec:org88c93b9}]{The joint representation encodes odor + location}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb01e964}]{The joint representation encodes odor + location}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org583d53c}]{The joint representation encodes odor + location}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\label{sec:org6adb910}
\begin{frame}[label={sec:orgfd802a2}]{The model}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc708f55}]{The model}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\center
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgea3805f}]{Maximizing rewards}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3464634}]{Minimizing the number of steps to solve the task}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
Without joint representation
...
\begin{frame}[label={sec:orge57f1bf}]{What policy did the agent learned ?}
\vspace{-7em}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\end{frame}
\section{Next steps}
\label{sec:org0d1c85e}
\begin{frame}[label={sec:orgf22d0a0}]{Our RL model so far}
\begin{columns}
...
\begin{frame}[label={sec:org401082e}]{Next step : from tabular RL to deep RL}
\begin{columns}
\begin{column}[t]{0.55\columnwidth}
% \usepackage{fontawesome5}
\usetikzlibrary{positioning,fit,arrows}
...
\begin{frame}[<+->][label={sec:org441e60f}]{Summary}
\begin{itemize}
...
\section{Backup}
\label{sec:org02b4630}
\begin{frame}[label={sec:org9ff3be0}]{Policy learned in the egocentric version}
\addtocounter{framenumber}{-1}
\begin{center}
