...
\label{sec:orgf34c394}
\begin{frame}[label={sec:orgda4cbe0},plain]{Collaborators}
%\addtocounter{framenumber}{-1}
...
\section*{Context}
\label{sec:org25c12e2}
\begin{frame}[label={sec:orgff236ac}]{The LEC is key to sensory associations and spatial memory}
\begin{columns}
...
\begin{frame}[label={sec:org328f458}]{Diamond arena experimental setup}
...
\end{frame}
\begin{frame}[label={sec:org3a20667}]{Diamond arena olfactory task}
\begin{textblock}{0.2}(1,0.071)%
\center%
\includegraphics[width=3em]{img/olivia.jpg}\\
\scriptsize
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf8e709c}]{Diamond arena olfactory task}
\addtocounter{framenumber}{-1}
\begin{textblock}{0.2}(1,0.071)%
\center%
\includegraphics[width=3em]{img/olivia.jpg}\\
...
\end{columns}
\end{frame}
\begin{frame}[<+->][label={sec:orgd04899e}]{What is Reinforcement Learning and why use it ?}
\begin{columns}
\begin{column}{0.55\columnwidth}
% \usepackage{fontawesome5}
...
\begin{frame}[label={sec:org1ffac30}]{RL maps states to actions}
\center
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=\textheight]{img/RL_mapping-1.drawio.png}};
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org9f40d4c}]{RL maps states to actions}
\center
\addtocounter{framenumber}{-1}
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=\textheight]{img/RL_mapping-1.drawio.png}};
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgdbb400d}]{RL maps states to actions}
\addtocounter{framenumber}{-1}
\center
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=\textheight]{img/RL_mapping-1.drawio.png}};
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgf974748}]{RL maps states to actions}
\addtocounter{framenumber}{-1}
\center
\begin{tikzpicture}
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:orgdf5d628}]{RL maps states to actions}
\addtocounter{framenumber}{-1}
\center
\begin{tikzpicture}
...
\end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org9ef2173},standout]{~}
\raggedright
Which representations are needed by the brain to learn a place-odor association task ?
\end{frame}
\begin{frame}[label={sec:org2d9962e}]{The joint representation encodes odor + location}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org776c9e4}]{The joint representation encodes odor + location}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org538bc67}]{The joint representation encodes odor + location}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.33\columnwidth}
\begin{center}
...
\label{sec:org0c5b504}
\begin{frame}[label={sec:org6e43f5f}]{The model}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb828b14}]{The model}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\center
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge700521}]{Maximizing rewards}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf1807f2}]{Minimizing the number of steps to solve the task}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
Without joint representation
...
\begin{frame}[label={sec:orgce6a44e}]{What policy did the agent learned ?}
\vspace{-7em}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4be4351}]{What policy did the agent learned ?}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\end{frame}
\section{Next steps}
\label{sec:org93f5ad1}
\begin{frame}[label={sec:org90847be}]{Our RL model so far}
\begin{columns}
...
\begin{frame}[label={sec:orgd144540}]{Next step : from tabular RL to deep RL}
\begin{columns}
\begin{column}[t]{0.55\columnwidth}
% \usepackage{fontawesome5}
\usetikzlibrary{positioning,fit,arrows}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org735ff8f}]{What types of representations are in use to solve an odor-place association task ?}
\begin{center}
...
\begin{frame}[<+->][label={sec:org10bdb82}]{Summary}
\begin{itemize}
...
\section{Backup}
\label{sec:org657e083}
\begin{frame}[label={sec:org0fd12f5}]{Policy learned in the egocentric version}
\addtocounter{framenumber}{-1}
\begin{center}
