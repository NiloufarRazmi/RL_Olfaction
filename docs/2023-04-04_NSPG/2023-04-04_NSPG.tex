...
\label{sec:orgd77a2e5}
\section*{Context}
\label{sec:orgb7f49e9}
{%
...
\begin{frame}[label={sec:org9ecbf9e}]{Diamond arena experimental setup}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5245553}]{Diamond arena olfactory task}
...
\begin{frame}[<+->][label={sec:org268e49d}]{What is Reinforcement Learning and why use it ?}
\begin{columns}
\begin{column}{0.55\columnwidth}
% \usepackage{fontawesome5}
...
\label{sec:org28367b5}
\begin{frame}[label={sec:org9eb7334}]{Allocentric vs. Egocentric}
\begin{columns}
\begin{column}{0.5\columnwidth}
\center
Allocentric
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc26ac97}]{The model}
\begin{columns}
\begin{column}{0.5\columnwidth}
\center
Allocentric
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org239fa30}]{The model}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\center
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfa80403}]{The joint representation encodes odor + location}
\begin{center}
\includegraphics[width=.9\linewidth]{img/joint-repr.drawio.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge8b1e2b}]{Minimizing the number of steps to solve the task}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org844a1f5}]{Maximizing rewards}
\begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
With joint representation
...
\end{frame}
\section{Next steps}
\label{sec:org80f82d7}
\begin{frame}[label={sec:org5089755}]{From tabular RL to deep RL}
\center
% \usepackage{fontawesome5}
\usetikzlibrary{positioning,fit,arrows}
...
\begin{frame}[label={sec:org5213989}]{From tabular RL to deep RL}
\center
\addtocounter{framenumber}{-1}
% \usepackage{fontawesome5}
\usetikzlibrary{positioning,fit,arrows}
