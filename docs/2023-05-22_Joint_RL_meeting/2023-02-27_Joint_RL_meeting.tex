...
\label{sec:orgd197184}
\begin{frame}[label={sec:org4e58741}]{Features matrix -- allocentric agent}
\(\to\) Reduced from 100 to 25 locations + 4 cues
\begin{center}
\includegraphics[height=0.8\textheight]{img/FuncApprox-allo-features-matrix.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4c475c3}]{Rewards and steps -- allocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-allo-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2ad4e48}]{Q-values learned -- allocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-allo-q-values.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org9297f74}]{Features matrix -- egocentric agent}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org8fca5e8}]{Rewards and steps -- egocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-ego-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0acdbd6}]{Q-values learned -- egocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-ego-q-values.png}
\end{center}
\end{frame}
\section{Deep Reinforcement Learning first draft}
\label{sec:orgb4cef1b}
\begin{frame}[label={sec:orge4b140c}]{Toy task : Random Walk 1D}
\begin{center}
\includegraphics[width=.9\linewidth]{img/RandomWalk1D.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org51e76c9}]{Network used}
\begin{center}
