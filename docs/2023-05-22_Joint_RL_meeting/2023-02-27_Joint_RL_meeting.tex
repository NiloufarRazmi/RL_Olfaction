...
\label{sec:org991eddd}
\begin{frame}[label={sec:org9fc4b54}]{Features matrix -- allocentric agent}
\(\to\) Reduced from 100 to 25 locations + 4 cues
\begin{center}
\includegraphics[height=0.8\textheight]{img/FuncApprox-allo-features-matrix.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5da0e92}]{Rewards and steps -- allocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-allo-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org96bebc9}]{Q-values learned -- allocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-allo-q-values.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbe0187e}]{Features matrix -- egocentric agent}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga2faaf8}]{Rewards and steps -- egocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-ego-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfdd52d7}]{Q-values learned -- egocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-ego-q-values.png}
\end{center}
\end{frame}
\section{Deep Reinforcement Learning -- first draft}
\label{sec:org85270c6}
\begin{frame}[label={sec:orgb35e4eb}]{Toy task : Random Walk 1D}
\begin{center}
\includegraphics[width=.9\linewidth]{img/RandomWalk1D.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgca709cf}]{Network used}
\begin{center}
