...
\label{sec:org989f42f}
\begin{frame}[label={sec:org0ee3abf}]{Features matrix -- allocentric agent}
\(\to\) Reduced from 100 to 25 locations + 4 cues
\begin{center}
\includegraphics[height=0.8\textheight]{img/FuncApprox-allo-features-matrix.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4fc3c9c}]{Rewards and steps -- allocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-allo-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org44f670a}]{Q-values learned -- allocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-allo-q-values.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org40ec2fb}]{Features matrix -- egocentric agent}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org18d08ec}]{Rewards and steps -- egocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-ego-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org81bbe5a}]{Q-values learned -- egocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-ego-q-values.png}
\end{center}
\end{frame}
\section{Deep Reinforcement Learning -- first draft}
\label{sec:org55a7c69}
\begin{frame}[label={sec:org7d00b60}]{Toy task : Random Walk 1D}
\begin{center}
\includegraphics[width=.9\linewidth]{img/RandomWalk1D.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2f5db7d}]{Network used}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org42650cf}]{Algorithm}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org8c4e4ae}]{States and actions}
\begin{center}
