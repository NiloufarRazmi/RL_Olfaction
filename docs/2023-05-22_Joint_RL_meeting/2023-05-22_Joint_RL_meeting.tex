...
\date{May 22\textsuperscript{nd}, 2023}
...
\label{sec:orgce832da}
\begin{frame}[label={sec:orgd1a93b1}]{Features matrix -- allocentric agent}
\(\to\) Reduced from 100 to 25 locations + 4 cues
\begin{center}
\includegraphics[height=0.8\textheight]{img/FuncApprox-allo-features-matrix.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org47049d8}]{Rewards and steps -- allocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-allo-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc72ffa1}]{Q-values learned -- allocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-allo-q-values.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7adb428}]{Features matrix -- egocentric agent}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgde732d9}]{Rewards and steps -- egocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-ego-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga88f89c}]{Q-values learned -- egocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-ego-q-values.png}
\end{center}
\end{frame}
\section{Deep Reinforcement Learning -- first draft}
\label{sec:org8ff6835}
\begin{frame}[label={sec:org0ae361c}]{Toy task : Random Walk 1D}
\begin{center}
\includegraphics[width=.9\linewidth]{img/RandomWalk1D.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org89ffe2b}]{Network used}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb6f07ad}]{Algorithm}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org83397d0}]{States and actions}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb0ed181}]{Rewards and steps}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4a66d56}]{Q-values learned}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org8aaab3d},standout]{~}
Questions ?
\end{frame}
\end{document}
