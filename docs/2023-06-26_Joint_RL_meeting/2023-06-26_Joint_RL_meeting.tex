...
\end{center}
\end{frame}
\begin{frame}[label={sec:org917fab9}]{Q-values learned -- allocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-allo-q-values.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge52bd61}]{Features matrix -- egocentric agent}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org9b89dfb}]{Rewards and steps -- egocentric agent}
\begin{center}
\includegraphics[width=\textwidth]{img/FuncApprox-ego-rewards-steps.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4f45185}]{Q-values learned -- egocentric agent}
\begin{center}
\includegraphics[width=.9\linewidth]{img/FuncApprox-ego-q-values.png}
\end{center}
\end{frame}
\section{Deep RL -- first draft \& issues}
\label{sec:orge8149cc}
\begin{frame}[label={sec:orgdd36952}]{Toy task : Random Walk 1D}
\begin{center}
\includegraphics[width=.9\linewidth]{img/RandomWalk1D-transparent.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgdb189ea}]{Network used}
