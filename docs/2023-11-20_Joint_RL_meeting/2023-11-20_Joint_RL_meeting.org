...
** TODO Vector or zeros instead of scalar Q value in the loss function
** TODO One hot encoding of state inputs
** See correlation matrices of Wilson's paper
** See Yanniv's paper
** Add a time dimsension to correlation matrices
** Check MIND algorithm
** RNN
** TODO Monhly default schedule
** TODO Next session plan with gantt chart
** TODO Meet with Niloufar to compare code next week
