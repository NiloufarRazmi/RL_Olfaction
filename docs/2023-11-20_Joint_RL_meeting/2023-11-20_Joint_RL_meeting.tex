...
\end{center}
\end{frame}
\begin{frame}[label={sec:org51f8f91}]{Paths followed until today\ldots{}}
\begin{enumerate}
...
\label{sec:org13189fe}
\begin{frame}[label={sec:org1fb81de}]{Toy task : Random Walk 1D}
\begin{center}
\includegraphics[width=.9\linewidth]{img/RandomWalk1D-transparent.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgeebbf08}]{Network used}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfa44bba},standout]{~}
Questions ?
\end{frame}
\end{document}