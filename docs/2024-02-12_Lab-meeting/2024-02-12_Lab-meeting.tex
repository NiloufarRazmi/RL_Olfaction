...
\section{Context}
\label{sec:orga237198}
\begin{frame}[label={sec:orgd34f01e}]{How do neurons in the LEC integrate sensory and spatial information?}
\begin{columns}
...
\label{sec:org6bf6b07}
\begin{frame}[<+->][label={sec:org0e4c681}]{Deep RL lessons learned}
\small
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org02d3416}]{Deep RL implementation}
...
\end{frame}
\section{Results}
\label{sec:orgfe5e503}
\begin{frame}[label={sec:orgbb5897d},standout]{How deep RL feels like}
\begin{center}
\includegraphics[width=.9\linewidth]{img/blog-main-img_pen-balance-with-energel-pens.jpg}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge9a721e}]{Networks architectures}
\centering
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org696cf89}]{Rewards \& steps}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org041ea2d}]{Loss, rewards \& steps distributions}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd0b01db}]{Policy learned (when it works)}
\begin{center}
\includegraphics[width=.9\linewidth]{img/policy-learned.png}
\end{center}
\end{frame}
\section{Future directions}
\label{sec:orgcf9d9b4}
\begin{frame}[label={sec:org1916ef7}]{Adding memory into the task}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5335db3}]{RNN for memorization and sequence modeling}
\begin{center}
\includegraphics[width=0.7\textwidth]{img/RNN-transparent.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga34efdc}]{Feedback connectivity}
\begin{center}
\includegraphics[width=0.6\textwidth]{img/Network types - The Computational Brain - transparent.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org16f1398}]{Network of networks}
\begin{center}
...
\end{textblock}
\end{frame}
\begin{frame}[label={sec:org4c6d6a1},standout]{~}
Questions ?
\end{frame}
\end{document}
