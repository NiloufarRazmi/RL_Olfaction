...
\section{Context}
\label{sec:org8f1ca38}
\begin{frame}[label={sec:orgb18719c}]{How do neurons in the LEC integrate sensory and spatial information?}
\begin{columns}
...
\label{sec:org120265d}
\begin{frame}[<+->][label={sec:orgde018e6}]{Deep RL lessons learned}
\small
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge815aca}]{Deep RL implementation}
...
\end{frame}
\section{Results}
\label{sec:orge269ff2}
\begin{frame}[label={sec:org4367cdd},standout]{How deep RL feels like}
\begin{center}
\includegraphics[width=.9\linewidth]{img/blog-main-img_pen-balance-with-energel-pens.jpg}
\end{center}
\end{frame}
\begin{frame}[label={sec:org611daeb}]{Networks architectures}
\centering
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4a19398}]{Rewards \& steps}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgcdab250}]{Loss, rewards \& steps distributions}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga7b45f4}]{Policy learned (when it works)}
\begin{center}
\includegraphics[width=.9\linewidth]{img/policy-learned.png}
\end{center}
\end{frame}
\section{Future directions}
\label{sec:org0970093}
\begin{frame}[label={sec:org749c655}]{Adding memory into the task}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc40dd8c}]{RNN for memorization and sequence modeling}
\begin{center}
\includegraphics[width=0.7\textwidth]{img/RNN-transparent.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org93dd61d}]{Feedback connectivity}
\begin{center}
\includegraphics[width=0.6\textwidth]{img/Network types - The Computational Brain - transparent.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5e69371}]{Network of networks}
\begin{center}
...
\end{textblock}
\end{frame}
\begin{frame}[label={sec:orgc2f3ed3},standout]{~}
Questions ?
\end{frame}
\end{document}
