...
** Training only on the lower triangle
#+ATTR_LaTeX: :width \linewidth
[[file:img/steps-and-rewards-lower-only.png]]
** Generalization test: training only on the lower triangle then switch to upper triangle
[[file:img/steps-and-rewards_upper-then-lower1.png]]
[[file:img/steps-and-rewards_upper-then-lower2.png]]
** Loss, exploration/exploitation rate
*** Left :BMCOL:
:PROPERTIES:
:BEAMER_col: 0.5
:END:
