...
** [?] Remove ReLU on input layer?
** direction vector
3 angles
- sin
- cos
- tan
** Angular activatino funct
** Most likely head directions instead of everything
** Look sampled trials behavior
** Does the agent look
** Plot trajectoies/state occupancy
** Try other left/right task
*** And compare activations with east/west
