...
\label{sec:org4d50c71}
\begin{frame}[label={sec:org6edc5eb}]{The LEC is key to sensory associations and spatial memory}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org864eea1}]{Half triangle task for olfactory-spatial association learning}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaed6117}]{Deep Reinforcement Learning model}
\begin{center}
\includegraphics[height=0.95\textheight]{medias/nn.drawio.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfcceb63}]{Cartesian/polar duplicated coordinates experiment}
\begin{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgddb9de0}]{Questions \& Hypothesis}
\metroset{block=fill}
...
\end{exampleblock}
\end{frame}
\begin{frame}[<+->][label={sec:orgd7d47a6}]{Looking back\(\dots\)}
\footnotesize
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5ee3ba4}]{Training checks -- East/West}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6b1860e}]{Training checks -- Left/Right}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd6b3171}]{Agent behavior}
\begin{columns}
...
\label{sec:org5defc0a}
\begin{frame}[label={sec:org3a5fe03}]{Weights structure -- East/West}
\begin{center}
\includegraphics[height=0.96\textheight]{medias/weights-matrices-EastWest.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org128c068}]{Weights structure -- Left/Right}
\begin{center}
\includegraphics[height=0.96\textheight]{medias/weights-matrices-LeftRight.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org9101076}]{Weights clustering}
\begin{center}
East/West
\end{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1f4c4de}]{Activations learned -- East/West}
\begin{center}
\includegraphics[height=0.9\textheight]{medias/activations-learned-EastWest.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd9b7f3b}]{Activations learned -- Left/Right}
\begin{center}
\includegraphics[height=0.9\textheight]{medias/activations-learned-LeftRight.png}
\end{center}
\end{frame}
\begin{frame}[<+->][label={sec:orga977598}]{Use the behavior as proxy -- Perturbation experiment}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdc17362}]{Cartesian inputs unchanged -- polar inputs perturbed}
\begin{columns}
\begin{column}[c]{0.5\columnwidth}
\begin{center}
\small
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4b81dea}]{Polar inputs unchanged -- Cartesian inputs perturbed}
\begin{itemize}
...
\end{frame}
\section{Conclusion}
\label{sec:org2e43106}
\begin{frame}[<+->][label={sec:org100e4ba}]{Partial conclusions so far}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[<+->][label={sec:org7d61025}]{Next steps}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc6a11b6},standout]{~}
Questions ?
\end{frame}
\end{document}
