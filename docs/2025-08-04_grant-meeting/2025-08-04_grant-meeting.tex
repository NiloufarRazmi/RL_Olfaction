...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org235903e}]{Half triangle task for olfactory-spatial association learning}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd6d9df5}]{The environment}
\begin{center}
